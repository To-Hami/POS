                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href=""
                                                                       ...
                                                                       class="add-product-btn {{ in_array($product->id, $order->products->pluck('id')->toArray()) ? 'btn-default disabled' : 'btn-success add-product-btn' }} btn-sm">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th style="display: none">سعر الشراء</th>
                                    </tr>
                                    </thead>
                                    ...
                                    @foreach ($order->products as $product)
                                        <tr>
                                            <td>{{ $product->name }}</td>
                                            <td><input type="number" name="products[{{ $product->id }}][quantity]" data-price="{{ number_format($product->sale_price, 2) }}"  data-purchase="{{ number_format($product->purchase_price, 2) }}" class="form-control input-sm product-quantity" min="1" value="{{ $product->pivot->quantity }}"></td>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <li class="list-group-item">{{ $product->pivot->quantity }}</li>
