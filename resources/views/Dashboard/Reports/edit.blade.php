            ...
            <div class=" box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{route('dashboard.users.update',$user->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img class="img-thumbnail image-preview" style="width: 90px" src="{{'http://127.0.0.1:8000/uploads/users_images/'. $user->image}}" alt="">
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header d-flex p-0">
                                            @php
                                                $models = ['users','categories','products','clients', 'orders','reports'];
